...
const AdminPanel: React.FC<AdminPanelProps> = ({ 
  state, onAddPrompt, onDeletePrompt, onAddCategory, onDeleteCategory, onImport, onExport, onClearMessages, onDeleteMessage, onUpdatePin, onLogout
}) => {
  // Form State
                    ...
                    {settingTab === 'pin' && (
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6 text-center py-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">This 4-digit PIN is required every time you access the Admin Dashboard (Session Lock).</p>
                            </div>
